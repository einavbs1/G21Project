...
public class BorrowedBooksChartResultsController {
    ...
    public void goToSpecificBookScreen(ActionEvent event) throws IOException {
        ...
        scene.getStylesheets().add(getClass().getResource("/librarianGui/SpecificBookChartResults.css").toExternalForm());
    ...
    public void Back(ActionEvent event) throws IOException {
        ...
        Stage stage = new Stage();
        Scene scene = new Scene(root);
        scene.getStylesheets().add(getClass().getResource("/librarianGui/GenerateReports.css").toExternalForm());
        stage.setScene(scene);
