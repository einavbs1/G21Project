...
public class UpdateSubscriberDataController {
	...
	public void OpenCurrectBorrows(ActionEvent event) throws IOException {
		...
		FXMLLoader Loader = new FXMLLoader(getClass().getResource("/gui/CurrentBorrowBooks.fxml"));
		Parent Root = Loader.load();
		Stage Stage = new Stage();
		Scene Scene = new Scene(Root);
		Scene.getStylesheets().add(getClass().getResource("/gui/CurrentBorrowBooks.css").toExternalForm());
		Stage.setScene(Scene);
