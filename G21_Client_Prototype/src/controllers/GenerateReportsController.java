...
public class GenerateReportsController {
    ...
    public void showBorrowedBooksReport(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/BorrowedBooksChartResults.fxml"));
        Parent root = loader.load();
        Stage stage = new Stage();
        Scene scene = new Scene(root);
        scene.getStylesheets().add(getClass().getResource("/gui/BorrowedBooksChartResults.css").toExternalForm());
    ...
    public void showSubscriberStatusReport(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/SubscriberStatusChartResults.fxml"));
        Parent root = loader.load();
        Stage stage = new Stage();
        Scene scene = new Scene(root);
        scene.getStylesheets().add(getClass().getResource("/gui/SubscriberStatusChartResults.css").toExternalForm());
        stage.setScene(scene);
