...
public class SearchBookResultsController {
    ...
    public void OrderBook(ActionEvent event) throws IOException {
    	FXMLLoader Loader = new FXMLLoader(getClass().getResource("/gui/OrderBook.fxml"));
        Parent Root = Loader.load();
        Stage Stage = new Stage();
        Scene Scene = new Scene(Root);
        Scene.getStylesheets().add(getClass().getResource("/gui/OrderBook.css").toExternalForm());
        Stage.setScene(Scene);
	...
	public void start(Stage primaryStage) {
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/gui/SearchBookResults.fxml"));
			Scene scene = new Scene(root);
			scene.getStylesheets().add(getClass().getResource("/gui/SearchBookResults.css").toExternalForm());
