...
public class MenuController {
	...
	private void setUserselectComboBox() {
		...
		Userselect.setValue(UserSelect.ShowAllSubscribers.getDisplayName()); // Default selected value
	}
	...
	public void Select(ActionEvent event) throws Exception {
		...
		Pane root = loader
				.load(getClass().getResource("/gui/" + UserSelect.valueOf(userselect) + ".fxml").openStream());
