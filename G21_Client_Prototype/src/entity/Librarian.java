...
public class Librarian {
	...
	/** Author: Yuval.
	 * Constructor that load librarian from DB if exist. 
	 * @param id
	 */
	...
	/** Author: Yuval.
	 * Constructor that creates a new librarian and adds it to the DB.
	...
	/** Author: Yuval.
	 * private method that loading the details in this id librarian instance.
	...
	/** Author: Yuval.
	 *toString of librarian
	 */
	public String toString() {
		return librarian_id+", "+librarian_name+", "+librarian_password;
	}
